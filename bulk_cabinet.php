...
//	$header=__("");
  ...
  if ( isset( $_FILES['inputfile'] )) {
    ...
    $content .= '<div class="table">
                  <div>
                    <div>' . __("<a href=\"bulk_template_download.php?type=cabinets\" style=\"color:#1F497D;text-decoration:none;border:1px solid #1F497D;padding:4px 10px;border-radius:3px;\">&#11015; Download Sample Template (.xlsx)</a><br><br>Select file to upload:") . '
